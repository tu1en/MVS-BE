...
class EncodingTest {
    ...
    void testVietnameseCharacters() {
        ...
        String vietnameseText = "Xin chÃ o! ÄÃ¢y lÃ  tiáº¿ng Viá»‡t vá»›i cÃ¡c kÃ½ tá»± Ä‘áº·c biá»‡t: Ã¡Ã áº£Ã£áº¡Äƒáº¯áº±áº³áºµáº·Ã¢áº¥áº§áº©áº«áº­Ã©Ã¨áº»áº½áº¹Ãªáº¿á»á»ƒá»…á»‡Ã­Ã¬á»‰Ä©á»‹Ã³Ã²á»Ãµá»Ã´á»‘á»“á»•á»—á»™Æ¡á»›á»á»Ÿá»¡á»£ÃºÃ¹á»§Å©á»¥Æ°á»©á»«á»­á»¯á»±Ã½á»³á»·á»¹á»µÄ‘";
    ...
    void testEmojis() {
        ...
        String emojis = "Emojis: ðŸ˜€ðŸ˜ƒðŸ˜„ðŸ˜ðŸ˜†ðŸ˜…ðŸ˜‚ðŸ¤£ðŸ˜ŠðŸ˜‡ðŸ™‚ðŸ™ƒðŸ˜‰ðŸ˜ŒðŸ˜ðŸ¥°ðŸ˜˜ðŸ˜—ðŸ˜™ðŸ˜šðŸ˜‹ðŸ˜›ðŸ˜ðŸ˜œðŸ¤ªðŸ¤¨ðŸ§ðŸ¤“ðŸ˜ŽðŸ¤©ðŸ¥³";
    ...
    void testLogMessages() {
        ...
        logger.info("Mixed content: English + Tiáº¿ng Viá»‡t + ç‰¹æ®Šå­—ç¬¦ + Ø§Ù„Ø¹Ø±Ø¨ÙŠØ© + Ñ€ÑƒÑÑÐºÐ¸Ð¹ + æ—¥æœ¬èªž");
