...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    ...
    /**
     * Äáº¿m unread messages cho user
     */
    ...
    /**
     * TÃ¬m messages cÃ³ tá»« khÃ³a (search)
     */
    ...
    /**
     * TÃ¬m raise hand messages chÆ°a Ä‘Æ°á»£c xá»­ lÃ½
     */
    @Query("SELECT c FROM ChatMessage c WHERE c.liveStream = :liveStream " +
    ...
    /**
     * TÃ¬m messages reply cho message cá»¥ thá»ƒ
     */
