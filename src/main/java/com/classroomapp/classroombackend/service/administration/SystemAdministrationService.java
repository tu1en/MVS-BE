...
Page<AuditLog> getFilteredAuditLogs(Pageable pageable, String searchTerm, String action,
...
Object getTeacherStudentActivity(LocalDateTime startDate, LocalDateTime endDate);
