...
public class SyllabusServiceImpl implements SyllabusService {
    ...
    @Override
    public Page<SyllabusDto> searchSyllabuses(String keyword, String subject, String gradeLevel, Pageable pageable) {
        // Hiện tại chưa có logic lọc theo subject, gradeLevel
    ...
    public Optional<SyllabusDto> getSyllabusByClassroomId(Long classroomId) {
        return syllabusRepository.findByClassroomId(classroomId)
                .stream()
                .findFirst()
                .map(this::convertToDto);
    }
    ...
    public boolean classroomHasSyllabus(Long classroomId) {
        return !syllabusRepository.findByClassroomId(classroomId).isEmpty();
    }
