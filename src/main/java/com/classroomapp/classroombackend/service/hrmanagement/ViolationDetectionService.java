...
public interface ViolationDetectionService {
    ...
    /**
     * Get overdue violations that haven't been explained after specified days
     * @param daysSinceViolation number of days since violation occurred
     * @return list of overdue violation DTOs
     */
    List<com.classroomapp.classroombackend.dto.hrmanagement.AttendanceViolationDto> getOverdueViolations(int daysSinceViolation);

    /**
     * Escalate a violation to manager
     * @param violationId the violation ID
     * @param escalatedBy user ID who escalated the violation
    ...
    class ViolationDetectionSummary {
        ...
        public void aggregate(ViolationDetectionSummary other) {
            if (other == null) return;
            this.totalViolationsDetected += other.totalViolationsDetected;
            this.lateArrivals += other.lateArrivals;
            this.earlyDepartures += other.earlyDepartures;
            this.missingCheckIns += other.missingCheckIns;
            this.missingCheckOuts += other.missingCheckOuts;
            this.absentWithoutLeave += other.absentWithoutLeave;
