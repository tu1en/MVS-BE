 ...
 * Cung cáº¥p business logic cho quáº£n lÃ½ lá»‹ch lÃ m viá»‡c
 */
public interface ShiftScheduleService {
    ...
    enum ScheduleNotificationType {
        SCHEDULE_CREATED("Lá»‹ch lÃ m viá»‡c má»›i Ä‘Æ°á»£c táº¡o"),
        SCHEDULE_PUBLISHED("Lá»‹ch lÃ m viá»‡c Ä‘Ã£ Ä‘Æ°á»£c xuáº¥t báº£n"),
        SCHEDULE_UPDATED("Lá»‹ch lÃ m viá»‡c Ä‘Ã£ Ä‘Æ°á»£c cáº­p nháº­t"),
        SCHEDULE_CANCELLED("Lá»‹ch lÃ m viá»‡c Ä‘Ã£ bá»‹ há»§y"),
        SCHEDULE_ARCHIVED("Lá»‹ch lÃ m viá»‡c Ä‘Ã£ Ä‘Æ°á»£c lÆ°u trá»¯"),
        SCHEDULE_STARTING_SOON("Lá»‹ch lÃ m viá»‡c sáº¯p báº¯t Ä‘áº§u");
    ...
    class ScheduleConflictResult {
        ...
        public boolean hasConflict() { return hasConflict; } // âœ… ThÃªm method nÃ y
