...
public class LectureController {
    ...
    // Download lecture material - Fixed method to return a simple response
    @GetMapping("/lecture-materials/download/{materialId}")
    public ResponseEntity<String> downloadLectureMaterial(@PathVariable Long materialId) {
        ...
        if (materialOpt.isPresent()) {
            ...
            return ResponseEntity.ok(material.getDownloadUrl());
        } else {
            return ResponseEntity.notFound().build();
        }
    }
