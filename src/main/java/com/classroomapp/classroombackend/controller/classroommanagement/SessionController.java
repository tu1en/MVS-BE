...
public class SessionController {
    ...
    /**
     * Láº¥y táº¥t cáº£ sessions vá»›i pagination
     */
    @GetMapping
    ...
    public ResponseEntity<Page<SessionDto>> getAllSessions(
        ...
        log.info("ðŸ” Getting all sessions - User: {}", authentication.getName());
    ...
    public ResponseEntity<SessionDto> getSessionById(
        ...
        log.info("ðŸ” Getting session by ID: {} - User: {}", id, authentication.getName());
    ...
    public ResponseEntity<SessionDto> createSession(
        ...
        log.info("ðŸ“ Creating new session for classroom: {} - User: {}", createDto.getClassroomId(), authentication.getName());
    ...
    public ResponseEntity<SessionDto> updateSession(
        ...
        log.info("ðŸ“ Updating session ID: {} - User: {}", id, authentication.getName());
    ...
    public ResponseEntity<Map<String, Object>> deleteSession(
        ...
        log.info("ðŸ—‘ï¸ Deleting session ID: {} - User: {}", id, authentication.getName());
        sessionService.deleteSession(id);
        
        Map<String, Object> response = new HashMap<>();
        response.put("success", true);
        response.put("message", "XÃ³a session thÃ nh cÃ´ng");
    ...
    /**
     * Láº¥y sessions theo classroom ID
     */
    ...
    public ResponseEntity<List<SessionDto>> getSessionsByClassroom(
        ...
        log.info("ðŸ” Getting sessions for classroom ID: {} - User: {}", classroomId, authentication.getName());
        List<SessionDto> sessions = sessionService.getSessionsByClassroom(classroomId);
        return ResponseEntity.ok(sessions);
    }

    /**
     * Láº¥y sessions theo ngÃ y
     */
    ...
    public ResponseEntity<List<SessionDto>> getSessionsByDate(
        ...
        log.info("ðŸ” Getting sessions for date: {} - User: {}", date, authentication.getName());
