...
//                     dayInfo = getDayName(s.getStartDatetime().getDayOfWeek().getValue() - 1);
//                     timeInfo = s.getStartDatetime().toLocalTime().toString();
                    
//                     if (s.getEndDatetime() != null) {
//                         timeInfo += "-" + s.getEndDatetime().toLocalTime().toString();
//                     }
//                 }
                
//                 if (s.getTitle() != null) {
//                     titleInfo = s.getTitle();
//                 }
                
//                 if (s.getLocation() != null) {
//                     locationInfo = s.getLocation();
//                 }
                
//                 return dayInfo + " " + timeInfo + " | " + titleInfo + " | Location: " + locationInfo;
//             }).toList()
//         ));
//     }
...
//                 "⚠️ NO SCHEDULES FOUND - This is the problem!" :
...
//         // ✅ Fixed: Create schedules using new datetime approach
//         // Monday schedules
...
//     // ✅ Fixed: createSchedule method using new datetime fields
...
//         // ✅ Use new datetime fields instead of legacy fields
//         // Create a date for next week and set the correct day
//         java.time.LocalDate nextWeek = java.time.LocalDate.now().plusWeeks(1);
//         java.time.LocalDate targetDate = nextWeek.with(java.time.DayOfWeek.of(dayOfWeek + 1)); // +1 because Java uses 1=Monday
        
//         schedule.setStartDatetime(LocalDateTime.of(targetDate, startTime));
//         schedule.setEndDatetime(LocalDateTime.of(targetDate, endTime));
//         schedule.setLocation(location);
//         schedule.setTitle(title);
//         schedule.setDescription("Auto-generated schedule for " + title);
//         schedule.setColor("#3498db"); // Default blue color
