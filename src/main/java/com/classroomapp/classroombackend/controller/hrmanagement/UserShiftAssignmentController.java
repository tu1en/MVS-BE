...
public class UserShiftAssignmentController {
    ...
    public ResponseEntity<Map<String, Object>> createShiftAssignments(@Valid @RequestBody CreateShiftAssignmentDto createDto) {
        try {
            ...
            response.put("message", "PhÃ¢n cÃ´ng ca lÃ m viá»‡c Ä‘Ã£ Ä‘Æ°á»£c táº¡o thÃ nh cÃ´ng");
    ...
    public ResponseEntity<Map<String, Object>> updateShiftAssignment(@PathVariable Long id, 
        ...
        try {
            ...
            Map<String, Object> response = new HashMap<>();
            response.put("success", true);
            response.put("message", "PhÃ¢n cÃ´ng ca lÃ m viá»‡c Ä‘Ã£ Ä‘Æ°á»£c cáº­p nháº­t thÃ nh cÃ´ng");
    ...
    public ResponseEntity<Map<String, Object>> deleteAssignment(@PathVariable Long id) {
        try {
            ...
            Map<String, Object> response = new HashMap<>();
            response.put("success", true);
            response.put("message", "PhÃ¢n cÃ´ng ca lÃ m viá»‡c Ä‘Ã£ Ä‘Æ°á»£c xÃ³a thÃ nh cÃ´ng");
    ...
    public ResponseEntity<Map<String, Object>> toggleAssignmentStatus(@PathVariable Long id, 
        ...
        try {
            ...
            Map<String, Object> response = new HashMap<>();
            response.put("success", true);
            response.put("message", isActive ? "PhÃ¢n cÃ´ng ca Ä‘Ã£ Ä‘Æ°á»£c kÃ­ch hoáº¡t" : "PhÃ¢n cÃ´ng ca Ä‘Ã£ Ä‘Æ°á»£c vÃ´ hiá»‡u hÃ³a");
            response.put("data", updatedAssignment);
            ...
            Map<String, Object> response = new HashMap<>();
            response.put("success", false);
            response.put("message", "CÃ³ lá»—i xáº£y ra khi thay Ä‘á»•i tráº¡ng thÃ¡i phÃ¢n cÃ´ng");
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    }
}
