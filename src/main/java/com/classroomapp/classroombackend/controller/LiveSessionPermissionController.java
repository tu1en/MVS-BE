...
/**
 * Controller Ä‘á»ƒ quáº£n lÃ½ permissions cho live sessions
 */
@RestController
...
public class LiveSessionPermissionController {
    ...
    /**
     * Grant permission cho student (chá»‰ teacher)
     */
    @PostMapping("/grant")
    ...
    /**
     * Deny permission cho student (chá»‰ teacher)
     */
    @PostMapping("/deny")
    @PreAuthorize("hasRole('TEACHER')")
    ...
    /**
     * Revoke permission tá»« student (chá»‰ teacher)
     */
    @PostMapping("/revoke")
    @PreAuthorize("hasRole('TEACHER')")
    ...
    /**
     * Láº¥y táº¥t cáº£ permissions cá»§a student
     */
    ...
    /**
     * Láº¥y táº¥t cáº£ student permissions trong live session (chá»‰ teacher)
     */
    ...
    /**
     * Grant permission cho táº¥t cáº£ students (chá»‰ teacher)
     */
    ...
    /**
     * Revoke permission tá»« táº¥t cáº£ students (chá»‰ teacher)
     */
    ...
    /**
     * Láº¥y pending permission requests (chá»‰ teacher)
     */
    ...
    /**
     * Approve hoáº·c deny permission request (chá»‰ teacher)
     */
    ...
    /**
     * Láº¥y permission statistics (chá»‰ teacher)
     */
