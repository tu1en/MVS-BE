...
public class SeederTestRunner implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            try {
                ...
                System.out.println("ðŸ›‘ Auto-shutting down application...");
                context.close();
                System.exit(0);
    ...
    public void run(String... args) throws Exception {
        System.out.println("ðŸš€ [SeederTestRunner] Starting seeder verification...");
        System.out.println("â³ [SeederTestRunner] Waiting for DataLoader to complete...");
        
        // Wait a bit for DataLoader to finish
        Thread.sleep(5000);
        
        System.out.println("ðŸ“Š [SeederTestRunner] Checking table counts...");
        ...
        System.out.println("ðŸ“‹ [SeederTestRunner] TABLE COUNTS:");
        System.out.println("  ðŸ‘¥ Users: " + userCount);
        System.out.println("  ðŸ” Roles: " + roleCount);
        System.out.println("  ðŸ« Classrooms: " + classroomCount);
        System.out.println("  âš™ï¸ System Roles: " + systemRoleCount);
        System.out.println("  ðŸ”‘ System Permissions: " + systemPermissionCount);
        System.out.println("  ðŸ”— Role Permissions: " + rolePermissionCount);
        System.out.println("  âš™ï¸ System Configurations: " + systemConfigCount);
        System.out.println("  ðŸ“ Audit Logs: " + auditLogCount);
        System.out.println("  ðŸ¥ Absences: " + absenceCount);
        System.out.println("  ðŸ“¨ Requests: " + requestCount);
        System.out.println("  ðŸ“Š System Monitoring: " + systemMonitoringCount);
        System.out.println("  ðŸ“š Syllabi: " + syllabusCount);
        ...
        System.out.println("ðŸ“Š [SeederTestRunner] TOTAL RECORDS: " + totalRecords);
        ...
        System.out.println("ðŸŽ¯ [SeederTestRunner] EMPTY TABLES: " + emptyTables + "/12");
        
        if (emptyTables == 0) {
            System.out.println("ðŸŽ‰ [SeederTestRunner] SUCCESS! Achieved 0 empty tables!");
            System.out.println("ðŸ† [SeederTestRunner] All seeders working perfectly!");
            ...
            System.out.println("âŒ [SeederTestRunner] SEEDERS NOT WORKING!");
            System.out.println("ðŸ”§ [SeederTestRunner] Empty tables: " + emptyTablesList.toString());
            
            // Try to run FinalTableSeeder manually if most tables are empty
            if (emptyTables > 8) {
                System.out.println("ðŸ”„ [SeederTestRunner] Attempting to run FinalTableSeeder manually...");
                try {
                    ...
                    System.out.println("ðŸ“Š [SeederTestRunner] UPDATED COUNTS:");
                    System.out.println("  ðŸ¥ Absences: " + absenceCount);
                    System.out.println("  ðŸ“¨ Requests: " + requestCount);
                    System.out.println("  ðŸ“Š System Monitoring: " + systemMonitoringCount);
                    System.out.println("  ðŸ“š Syllabi: " + syllabusCount);
                    ...
                    System.out.println("âŒ [SeederTestRunner] FinalTableSeeder failed: " + e.getMessage());
                }
            }
        }
        ...
        System.out.println("ðŸ“ˆ [SeederTestRunner] PROGRESS: " + tablesWithData + "/12 tables (" + 
                          String.format("%.1f", progressPercent) + "%)");
        
        System.out.println("âœ… [SeederTestRunner] Verification completed!");
        System.out.println("ðŸ›‘ [SeederTestRunner] Application will auto-shutdown in 5 seconds...");
    }
}
