...
/**
 * Entity Ä‘á»ƒ lÆ°u trá»¯ tin nháº¯n chat trong live sessions
 */
@Entity
...
public class ChatMessage {
    ...
    private String emojiReactions; // JSON string Ä‘á»ƒ lÆ°u reactions
    ...
    public static ChatMessage createRaiseHandMessage(LiveStream liveStream, User student) {
        return ChatMessage.builder()
                ...
                .content(student.getFullName() + " Ä‘Ã£ giÆ¡ tay")
