...
/**
 * Entity Ä‘á»ƒ lÆ°u trá»¯ dá»¯ liá»‡u whiteboard trong live sessions
 */
@Entity
...
public class WhiteboardData {
    ...
    private String elementId; // Unique ID cho má»—i drawing element
    
    @Column(name = "text_content", length = 1000)
    private String textContent; // Ná»™i dung text náº¿u lÃ  text element
    ...
    private Long sequenceNumber; // Äá»ƒ maintain order cá»§a cÃ¡c actions
