...
public class ExplanationEvidence {
    ...
    @NotNull(message = "Giáº£i trÃ¬nh khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    ...
    @NotBlank(message = "ÄÆ°á»ng dáº«n file khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    @Column(name = "file_path", columnDefinition = "NVARCHAR(500)", nullable = false)
    private String filePath;

    @NotBlank(message = "URL file khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    ...
    public enum EvidenceType {
        DOCUMENT("TÃ i liá»‡u"),
        IMAGE("HÃ¬nh áº£nh"),
        MEDICAL_CERTIFICATE("Giáº¥y khÃ¡m bá»‡nh"),
        OFFICIAL_LETTER("CÃ´ng vÄƒn"),
        RECEIPT("HÃ³a Ä‘Æ¡n/BiÃªn lai"),
        OTHER("KhÃ¡c");
    ...
    public String getSecurityInfo() {
        ...
        if (createdAt != null) {
            ...
            info.append("Táº£i lÃªn: ").append(createdAt.toLocalDate());
        }
        
        if (isVerified()) {
            if (info.length() > 0) info.append(" | ");
            info.append("ÄÃ£ xÃ¡c minh");
        }
