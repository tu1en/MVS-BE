...
public class ViolationExplanation {
    ...
    @NotNull(message = "Vi pháº¡m khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "violation_id", nullable = false)
    private AttendanceViolation violation;

    @NotNull(message = "NgÆ°á»i gá»­i giáº£i trÃ¬nh khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "submitted_by", nullable = false)
    private User submittedBy;

    @NotBlank(message = "LÃ½ do giáº£i trÃ¬nh khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    ...
    public enum ExplanationStatus {
        ...
        REQUIRES_MORE_INFO("Cáº§n thÃªm thÃ´ng tin");
    ...
    public String getSubmissionInfo() {
        ...
        if (submittedBy != null) {
            info.append("Gá»­i bá»Ÿi: ").append(submittedBy.getFullName());
        }
        
        if (submittedAt != null) {
            info.append(" vÃ o ").append(submittedAt.toLocalDate());
        }
    ...
    public String getReviewInfo() {
        if (reviewedBy == null || reviewedAt == null) {
            return "ChÆ°a Ä‘Æ°á»£c xem xÃ©t";
        }
        
        StringBuilder info = new StringBuilder();
        info.append("Xem xÃ©t bá»Ÿi: ").append(reviewedBy.getFullName())
            .append(" vÃ o ").append(reviewedAt.toLocalDate())
