...
public class AttendanceViolation {
    ...
    @Column(name = "escalation_reason", columnDefinition = "NVARCHAR(1000)")
    ...
    public enum ViolationType {
        ...
        EXTENDED_BREAK("Nghỉ giải lao quá thời gian"),
        UNAUTHORIZED_OVERTIME("Tăng ca không có phép"),
        MULTIPLE_VIOLATIONS("Vi phạm nhiều lần trong ngày");
