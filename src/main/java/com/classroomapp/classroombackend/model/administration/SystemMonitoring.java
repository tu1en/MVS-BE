...
public class SystemMonitoring {
    ...
    public enum MonitoringCategory {
        SYSTEM("HÃ¡Â»â€¡ thÃ¡Â»â€˜ng"),
        DATABASE("CÃ†Â¡ sÃ¡Â»Å¸ dÃ¡Â»Â¯ liÃ¡Â»â€¡u"),
        APPLICATION("Ã¡Â»Â¨ng dÃ¡Â»Â¥ng"),
        NETWORK("MÃ¡ÂºÂ¡ng"),
        SECURITY("BÃ¡ÂºÂ£o mÃ¡ÂºÂ­t"),
        PERFORMANCE("HiÃ¡Â»â€¡u suÃ¡ÂºÂ¥t"),
        STORAGE("LÃ†Â°u trÃ¡Â»Â¯"),
        MEMORY("BÃ¡Â»â„¢ nhÃ¡Â»â€º"),
        CPU("CPU"),
        DISK("Ã¡Â»â€ Ã„â€˜Ã„Â©a"),
        USER_ACTIVITY("HoÃ¡ÂºÂ¡t Ã„â€˜Ã¡Â»â„¢ng ngÃ†Â°Ã¡Â»Âi dÃƒÂ¹ng"),
        ERROR_RATE("TÃ¡Â»Â· lÃ¡Â»â€¡ lÃ¡Â»â€”i"),
        RESPONSE_TIME("ThÃ¡Â»Âi gian phÃ¡ÂºÂ£n hÃ¡Â»â€œi"),
        THROUGHPUT("Throughput"),
        AVAILABILITY("KhÃ¡ÂºÂ£ dÃ¡Â»Â¥ng");
    ...
    public enum MetricStatus {
        NORMAL("BÃƒÂ¬nh thÃ†Â°Ã¡Â»Âng"),
        WARNING("CÃ¡ÂºÂ£nh bÃƒÂ¡o"),
        CRITICAL("NghiÃƒÂªm trÃ¡Â»Âng"),
        UNKNOWN("KhÃƒÂ´ng xÃƒÂ¡c Ã„â€˜Ã¡Â»â€¹nh");
    ...
    public String getTimeSinceUpdate() {
        ...
        if (minutes < 1) {
            return "VÃ¡Â»Â«a xong";
        } else if (minutes < 60) {
            return minutes + " phÃƒÂºt trÃ†Â°Ã¡Â»â€ºc";
        } else {
            long hours = minutes / 60;
            if (hours < 24) {
                return hours + " giÃ¡Â»Â trÃ†Â°Ã¡Â»â€ºc";
            } else {
                long days = hours / 24;
                return days + " ngÃƒÂ y trÃ†Â°Ã¡Â»â€ºc";
            }
        }
    }
