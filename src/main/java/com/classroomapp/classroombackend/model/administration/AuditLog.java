...
public class AuditLog {
    ...
    public enum AuditAction {
        ...
        LOGIN_FAILED("ÄÄƒng nháº­p tháº¥t báº¡i"),
        PASSWORD_CHANGE("Äá»•i máº­t kháº©u"),
        PASSWORD_RESET("Reset máº­t kháº©u"),
        PERMISSION_GRANT("Cáº¥p quyá»n"),
        PERMISSION_REVOKE("Thu há»“i quyá»n"),
        ROLE_ASSIGN("GÃ¡n role"),
        ROLE_REMOVE("Gá»¡ role"),
        CONFIG_CHANGE("Thay Ä‘á»•i cáº¥u hÃ¬nh"),
        EXPORT("Xuáº¥t dá»¯ liá»‡u"),
        IMPORT("Nháº­p dá»¯ liá»‡u"),
        BACKUP("Sao lÆ°u"),
        RESTORE("KhÃ´i phá»¥c"),
        SYSTEM_START("Khá»Ÿi Ä‘á»™ng há»‡ thá»‘ng"),
        SYSTEM_STOP("Dá»«ng há»‡ thá»‘ng"),
        ERROR("Lá»—i há»‡ thá»‘ng"),
        SECURITY_VIOLATION("Vi pháº¡m báº£o máº­t");
    ...
    public enum AuditCategory {
        ...
        DATA_MODIFICATION("Thay Ä‘á»•i dá»¯ liá»‡u"),
