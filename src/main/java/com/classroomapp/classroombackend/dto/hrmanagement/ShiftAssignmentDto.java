...
public class ShiftAssignmentDto {
    ...
    public String getStatusDescription() {
        ...
        return switch (status) {
            case SCHEDULED -> "ÄÃ£ lÃªn lá»‹ch";
            case IN_PROGRESS -> "Äang thá»±c hiá»‡n";
            case COMPLETED -> "HoÃ n thÃ nh";
            case CANCELLED -> "ÄÃ£ há»§y";
            case NO_SHOW -> "KhÃ´ng cÃ³ máº·t";
        };
    }
    ...
    public String getAttendanceStatusDescription() {
        ...
        return switch (attendanceStatus) {
            ...
            case PRESENT -> "CÃ³ máº·t";
            case ABSENT -> "Váº¯ng máº·t";
            case LATE -> "Äi muá»™n";
            case EARLY_LEAVE -> "Vá» sá»›m";
        };
    }
}
