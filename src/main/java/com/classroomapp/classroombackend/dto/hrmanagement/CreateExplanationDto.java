...
public class CreateExplanationDto {
    ...
    @NotNull(message = "ID vi pháº¡m khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    private Long violationId;
    
    @NotBlank(message = "LÃ½ do giáº£i trÃ¬nh khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    @Size(min = 10, max = 2000, message = "LÃ½ do giáº£i trÃ¬nh pháº£i tá»« 10-2000 kÃ½ tá»±")
    ...
    public List<String> getValidationErrors() {
        ...
        if (!isEvidenceDataConsistent()) {
            errors.add("Sá»‘ lÆ°á»£ng file vÃ  mÃ´ táº£ khÃ´ng khá»›p");
        }
        
        if (!isWithinSizeLimit()) {
            errors.add("Tá»•ng dung lÆ°á»£ng file vÆ°á»£t quÃ¡ 5MB");
        }
        
        if (!hasValidFileTypes()) {
            errors.add("CÃ³ file khÃ´ng Ä‘Ãºng Ä‘á»‹nh dáº¡ng cho phÃ©p: " + String.join(", ", getInvalidFileTypes()));
        }
        
        if (hasOversizedFiles()) {
            errors.add("CÃ³ file vÆ°á»£t quÃ¡ 2MB: " + String.join(", ", getOversizedFileNames()));
        }
