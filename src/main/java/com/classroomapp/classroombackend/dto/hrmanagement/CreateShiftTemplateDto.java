...
/**
 * DTO cho táº¡o má»›i máº«u ca lÃ m viá»‡c
 */
@Data
public class CreateShiftTemplateDto {
    ...
    @NotBlank(message = "MÃ£ template khÃ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng")
    @Size(max = 50, message = "MÃ£ template khÃ´ng Ä‘Æ°á»£c vÆ°á»£t quÃ¡ 50 kÃ½ tá»±")
