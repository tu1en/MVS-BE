...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setJdbcUrl("jdbc:sqlserver://localhost:1433;databaseName=SchoolManagementDB;encrypt=false;trustServerCertificate=true;sendStringParametersAsUnicode=true;sendTimeAsDateTime=false;");
